...
/**
 * Click on the next and Send button to resend the offer
 */
...
/**
 * Search with the edited train id
 */
actions.searchByTrainId(actions.rule15EditedTrainId)

/**
 * Verify the edited fields are present in the view
 */
CustomKeywords.'com.ge.tms.rule15.Rule15Verification.verifyResendOfferOfRule15'(actions.rule15EditedTrainId , actions.rule15EditedAuthNumber.toString())
