...
/**
 * Test Steps: Filter - Rule 15 offering
...
/**
 *  Actions applied to slect and apply filter
 */
rule15Action.selectFilterOptions()

/**
 * Verify the filtered combinations
 */
CustomKeywords.'com.ge.tms.rule15.Rule15Verification.verifyFilteredResults'()
