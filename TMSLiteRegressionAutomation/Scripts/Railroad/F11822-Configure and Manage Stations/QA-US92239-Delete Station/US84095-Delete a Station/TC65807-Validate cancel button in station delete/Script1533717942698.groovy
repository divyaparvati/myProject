...
5. Click on Delete Station
6. User gets a confirmation message 
7. Validate that when user clicks on the No button , user is navigated to the view of that station
*/
...
/**
  ...
  */
TestObject deleteNoButtonObj = findTestObject('Object Repository/F11822-Configure and Manage Stations/deleteConfirmationNoButton')
...
/**
  ...
  * user is navigated to View of that station
  */
String actualViewIdText = WebUI.getText(findTestObject('Object Repository/F11822-Configure and Manage Stations/QA-US87586-View Stations/US84086-View Station Details/View Stations/div_StationCode'))

CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyNoButtonInDeleteAction'(actualViewIdText, actions.stationId)
