 ...
 * This test case is to Add a new station
	  ...
	  4. Fill in all the mandatory fields and other fields
	  5. Click on save
...
/**
 * Verify the view details of the newly created station in the view and the response data
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifySelectedStationDetailsInRightPane'(actions.stationId)
