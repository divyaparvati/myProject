...
/**
 * Test Steps: Edit track and check for save button status
 *
 ...
 * 7. Edit one of the mandatory fields with empty or alphanumeric values
 * 8. Save shall not be enabled
 */
...
/**
 *  Click on Edit Track icon
 */
 actions.clickEditIconTrack()
 
/**
 *  Verify error messages in edit track
*/
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyTrackErrorMessages'('editTrack')

/**
 * Cancel the track modal
 */
