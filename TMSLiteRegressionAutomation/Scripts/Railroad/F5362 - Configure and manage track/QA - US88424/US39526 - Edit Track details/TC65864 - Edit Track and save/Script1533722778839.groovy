...
/**
 * Test Steps: Edit Track and save
 *
 ...
 * 7. Edit one of the mandatory fields
 * 8. Click on save
 * 9. Edited details for the track shall be saved in the row
 * 10. Delete the track created
 * 11. Delete the zone
 * 12. Delete the station
 /*
 ...
 *  Edit Track Details
 */
actions.editTrackLength()

/**
 *  Save Track after edit
 */
actions.saveTrack()
 ...
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyEditedTrackLength'()

/**
 *  Edit Track Type
 */
actions.editTrackType()
...
//** Defect raised for search by Track type
/* Defect id :  DE74919
 * Search by Track type is not working Hence the below verification is commented 
 */

///**
// *  Verify the edited Track type is saved
// */
//CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyEditedTrackType'()
