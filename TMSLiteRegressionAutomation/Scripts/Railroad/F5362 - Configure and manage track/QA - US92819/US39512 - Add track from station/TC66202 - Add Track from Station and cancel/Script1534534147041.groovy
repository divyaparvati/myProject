...
/**
 * Test Steps: Add Track from station and cancel
 * 
 ...
 * 6. In the newly opened window fill in the mandatory fields
 * 7. Click on cancel button
 * 8. Verify that new track shall not be created
 * 9. Delete the zone
...
/**
 *  Verify No track record is saved
 */
 CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyNoTracksFound'()
