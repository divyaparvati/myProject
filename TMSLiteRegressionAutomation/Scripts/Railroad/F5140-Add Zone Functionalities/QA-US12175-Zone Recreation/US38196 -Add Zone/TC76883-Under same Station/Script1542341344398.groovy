...
/**
 * Search for the station created in left navigation list and click on the station
 * To enable the Add new Zone button to create a new Zone under the same station
 */
actions.setTextForSearchInLeftNav(actions.stationId)
actions.selectFirstStation()

/**
 * Click on Add new zone button 
 */
actions.clickOnAddNewZoneButton()

/**
 * Verify the error message when same zone id is provided
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyIfZoneCanBeRecreatedUnderSameStation'(actions.zoneId)

/**
* Click on the zone  cancel button
*/
actions.clickOnZoneCancelButton()

/**
* Search for the zone created in the left navigation 
