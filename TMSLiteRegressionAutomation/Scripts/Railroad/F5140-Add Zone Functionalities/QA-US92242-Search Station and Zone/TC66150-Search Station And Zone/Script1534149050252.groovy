 ...
 * 4. Create a new zone under station
 * 5. Verify the search of that zone in left nav
 * 6. Delete the zone
 * 7. Verify the Search of the station in left nav
...
/**
 * Set Zone ID to search Station and Zone serch field
 */
actions.setStaionForZonezoneSearchField()

/**
 *  Call Zone ID Search method and verify the search results
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyZoneSearchWithZone'(actions.stationId, actions.zoneId)
...
/**
 *  Call Station ID Search method and verify the search results
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyStationSearchWithStation'(actions.stationId)
...
/**
  * Test object obtained for Yes button in Delete confirmation box
  */
TestObject deleteButtonObj = findTestObject('Object Repository/F11822-Configure and Manage Stations/deleteConfirmationYesButton')

/**
 * Click on the Yes button to confirm the delete action of station
 */
CustomKeywords.'com.ge.tms.commonactions.RailroadActions.clickOnTestObject'(deleteButtonObj)
