...
/**
 * Verify that when valid data is given the Zone Save button is enabled
 */
TestObject saveButtonObject = findTestObject('Object Repository/F5140-Add Zone Functionalities/QA-US88570-Add Zone/US38196-Save a New Zone/Add Edit Zone/zoneSaveButton')

util.verifySaveButtonEnabled(saveButtonObject)
