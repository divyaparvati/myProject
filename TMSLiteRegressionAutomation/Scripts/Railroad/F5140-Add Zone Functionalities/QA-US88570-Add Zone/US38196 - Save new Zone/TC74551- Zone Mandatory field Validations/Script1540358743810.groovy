 ...
 * 7. Verify the mandatory fields
 * 8. Delete the zone successfully
 * 9. Delete the station successfully
 */
/**
 ...
 */
actions.clickOnAddNewZoneButton()

/**
 * Getting saveButtonObject to verify Save button enable/disable
 * Method call to verify the Zone Save Button state ( Enable/Disable )
 */
TestObject zoneSaveButtonObject = findTestObject('Object Repository/F5140-Add Zone Functionalities/QA-US88570-Add Zone/US38196-Save a New Zone/Add Edit Zone/zoneSaveButton')

/**
 * To verify if the save button is disabled when no data is filled for add Zone
 */
util.verifySaveButtonDisabled(zoneSaveButtonObject)

/**
 * Verify for all mandatory fields in Add Zone
 * Verify for each scenario Save button will be disabled
 * Sending boolean value as true to indicate the Zone id is editable
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyZoneMandatoryFields'(true)

/**
 * Click on zone cancel button
 */
actions.clickOnZoneCancelButton()
