 ...
 *  7. Validate that when user clicks on Yes button  in confirmation message
 *           a. Zone is successfully deleted by validating that user is navigated back to the View of that Station
 *           b. Search for that deleted Zone in Search bar in Left navigation. - No search result needs to be shown
 ...
 */
TestObject deleteMessageObj = findTestObject('Object Repository/F5140-Add Zone Functionalities/QA-US88570-Add Zone/US38196-Save a New Zone/Delete Zone/deleteConfirmationMessage')

/**
 * Verify the delete confirmation message 
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyDeleteConfirmationMessage'(actions.zoneId, deleteMessageObj)
...
/**
* Verify that after zone deletion , deleted zone shall not be searched in left navigation
*/
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyDeletedItemNotPresentInSearchView'(actions.zoneId)

/**
  * To Clear the text box value
  */
actions.clearStationzoneSearchField()
