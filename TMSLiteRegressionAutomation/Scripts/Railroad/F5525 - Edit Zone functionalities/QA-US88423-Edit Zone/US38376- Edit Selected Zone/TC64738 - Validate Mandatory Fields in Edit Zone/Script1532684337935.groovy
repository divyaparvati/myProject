...
/**
 * Verify the mandatory fields in Edit zone
 * Sending boolean value as false to indicate the Zone id is non-editable
 */
CustomKeywords.'com.ge.tms.railroad.RailroadVerification.verifyZoneMandatoryFields'(false)
 
/**
 * Click on cancel button to go back to the view screen
 */
