 ...
 */
actions.generateRandomEquipmentID()

/**
 * set CarID to the left search pane
 */
actions.setequipmentIDToSearchPane(actions.randomEquipmentID)

/**
 * Verify car ID 
 */
CustomKeywords.'com.ge.tms.equipment.EquipmentVerification.verifyEquipmentID'(actions.randomEquipmentID)

/**
 * Verify Equipment data wit API
 */
CustomKeywords.'com.ge.tms.equipment.EquipmentVerification.verifyEquipmentRecord'(actions.randomEquipmentID)
